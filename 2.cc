...
//################################################################
      ...
      positionAlloc->Add(Vector(5.0, 0.0, 1.0));        // STA 2 (left)
      ...
      positionAllocAP->Add(Vector(2.5, 2.5, 1.0));        // AP in the middle
...
/////////////////////////////Application part///////////////////////////// 
  ...
  uint16_t dlPort = 1000;
    ...
    onOffHelper1.SetAttribute("PacketSize", UintegerValue(700));
