...
//################################################################
      ...
      positionAllocAP->Add(Vector(7.5, 4.4, 1.0));        // AP in the middle
...
/////////////////////////////Application part///////////////////////////// 
  ...
  uint16_t dlPort = 1000;
    ...
    ApplicationContainer onOffApp2; // For STA 3 to STA 4

    OnOffHelper onOffHelper1("ns3::UdpSocketFactory", InetSocketAddress(wifiInterfaces.GetAddress (1), dlPort)); //OnOffApplication, UDP traffic, Please refer the ns-3 API
    ...
    onOffHelper1.SetAttribute("DataRate", DataRateValue(DataRate("11.0Mbps"))); //Traffic Bit Rate
